...
$id_usuario_staff = $_SESSION["id_usuario"];
...
// ----------------------------------------------------
// 0. VERIFICAR QUE EL TRABAJADOR PERTENECE A UNA OFICINA
// ----------------------------------------------------
$query_staff = "SELECT id_oficina FROM datos_oficina_usuario WHERE id_usuario = '$id_usuario_staff' LIMIT 1";
...
$staff_row = mysqli_fetch_assoc($res_staff);
$id_oficina_staff = $staff_row['id_oficina'];

// ----------------------------------------------------
// 1. OBTENER DATOS GENERALES (el trámite debe estar actualmente
//    en la bandeja de la oficina del trabajador)
// ----------------------------------------------------
$query_tramite = "SELECT t.id_tramite, t.numero_expediente, t.asunto, t.descripcion_motivo,
                          t.fecha_envio, t.observacion_admin, t.id_usuario,
                          tp.nombre_tramite,
                          e.nombre_estado,
                   ...
                   WHERE t.id_tramite = '$id_tramite' AND t.id_oficina_actual = '$id_oficina_staff'
                   LIMIT 1";
...
$nombre_usuario = "";
$documento_usuario = "";
$id_usuario = $tramite['id_usuario']; // dueño real del trámite (no el trabajador)

$q_tipo = "SELECT id_tipo FROM usuarios WHERE id_usuario = '$id_usuario' LIMIT 1";
$r_tipo = mysqli_query($cn, $q_tipo);
$id_tipo = 0;
if ($f_tipo = mysqli_fetch_assoc($r_tipo)) {
    $id_tipo = $f_tipo['id_tipo'];
}
